...
{
	if (region.V.z === region.ac.z)
	{
		return 'on line ' + region.V.z;
	}
	return 'on lines ' + region.V.z + ' through ' + region.ac.z;
}
...
var _Http_toTask = F2(function(request, maybeProgress)
{
	return _Scheduler_binding(function(callback)
	{
		...
		xhr.addEventListener('load', function() {
			callback(_Http_handleResponse(xhr, request.P.a));
		});

		try
		{
			xhr.open(request.S, request.aX, true);
		}
		catch (e)
		{
...
function _Http_configureRequest(xhr, request)
{
	...
	xhr.responseType = request.P.b;
	xhr.withCredentials = request.Y;

	elm$core$Maybe$isJust(request.X) && (xhr.timeout = request.X.a);
}
...
function _Http_toResponse(xhr)
{
	return {
		aX: xhr.responseURL,
		aT: { aD: xhr.status, k: xhr.statusText },
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { aJ: 'hidden', x: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { aJ: 'mozHidden', x: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { aJ: 'msHidden', x: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { aJ: 'webkitHidden', x: 'webkitvisibilitychange' }
		: { aJ: 'hidden', x: 'visibilitychange' };
}
...
var author$project$Api$allLevels = A2(
...
var author$project$Api$computePercentage = F4(
	function (read_ok, read_nok, mean_ok, mean_nok) {
		return A5(
			elm$core$Maybe$map4,
			F4(
				function (a, b, c, d) {
...
var author$project$KanjiData$KanjiData = F4(
	function (level, character, srs, correct) {
		return {aC: character, aE: correct, aM: level, aS: srs};
	});
...
var author$project$Api$kanjiDecode = A8(
	elm$json$Json$Decode$map7,
	F7(
		function (level, character, srs, read_ok, read_nok, mean_ok, mean_nok) {
			return A4(
				author$project$KanjiData$KanjiData,
				level,
				character,
				srs,
				A4(author$project$Api$computePercentage, read_ok, read_nok, mean_ok, mean_nok));
		}),
	...
	elm$json$Json$Decode$maybe(
		A2(
			...
			_List_fromArray(
				['user_specific', 'srs_numeric']),
			elm$json$Json$Decode$int)),
	elm$json$Json$Decode$maybe(
		A2(
			elm$json$Json$Decode$at,
			_List_fromArray(
				['user_specific', 'reading_correct']),
			elm$json$Json$Decode$int)),
	elm$json$Json$Decode$maybe(
		A2(
			elm$json$Json$Decode$at,
			_List_fromArray(
				['user_specific', 'reading_incorrect']),
			elm$json$Json$Decode$int)),
	elm$json$Json$Decode$maybe(
		A2(
			elm$json$Json$Decode$at,
			_List_fromArray(
				['user_specific', 'meaning_correct']),
			elm$json$Json$Decode$int)),
	elm$json$Json$Decode$maybe(
		A2(
			elm$json$Json$Decode$at,
			_List_fromArray(
				['user_specific', 'meaning_incorrect']),
			elm$json$Json$Decode$int)));
var elm$json$Json$Decode$list = _Json_decodeList;
var author$project$Api$requestDecode = A2(
	elm$json$Json$Decode$field,
	'requested_information',
	elm$json$Json$Decode$list(author$project$Api$kanjiDecode));
...
var author$project$LoadingScreen$WindowResize = F2(
	function (a, b) {
		return {$: 1, a: a, b: b};
	});
var author$project$LoadingScreen$viewportToSize = function (vp) {
	return A2(author$project$LoadingScreen$WindowResize, vp.av.aZ, vp.av.aI);
};
...
var author$project$LoadingScreen$initCommands = function (params) {
	return elm$core$Platform$Cmd$batch(
		_List_fromArray(
			[
				A2(author$project$Api$getData, author$project$LoadingScreen$ReceivedKanjis, params.ag),
...
var author$project$LoadingScreen$initState = function (params) {
	return {
		_: elm$core$Maybe$Nothing,
		K: elm$core$Maybe$Nothing,
		M: elm$core$Maybe$Nothing,
		A: A2(elm$core$Maybe$withDefault, 0, params.A)
	};
};
var elm$core$Platform$Cmd$none = elm$core$Platform$Cmd$batch(_List_Nil);
var author$project$LoadingScreen$init = function (maybeParams) {
	if (!maybeParams.$) {
		var params = maybeParams.a;
		return _Utils_Tuple2(
			author$project$LoadingScreen$initState(params),
			author$project$LoadingScreen$initCommands(params));
	} else {
		return _Utils_Tuple2(
...
var author$project$Main$LoadingMsg = function (a) {
	return {$: 0, a: a};
};
var author$project$LoadingScreen$Params = F2(
	function (key, padding) {
		return {ag: key, A: padding};
	});
...
var author$project$Main$parseUrl = function (stringUrl) {
	...
	var parser = A2(
		...
		A2(
			...
			A3(
				...
				elm$url$Url$Parser$Query$int('padding'))));
	var parse = function (url) {
		var _n0 = A2(elm$url$Url$Parser$parse, parser, url);
		if ((!_n0.$) && (!_n0.a.a.$)) {
			var _n1 = _n0.a;
			var key = _n1.a.a;
			var maybePadding = _n1.b;
			return elm$core$Maybe$Just(
				A2(author$project$LoadingScreen$Params, key, maybePadding));
		} else {
			return elm$core$Maybe$Nothing;
		}
	};
	return A2(
		...
		parse,
		elm$url$Url$fromString(stringUrl));
};
var elm$core$Platform$Cmd$map = _Platform_map;
var author$project$Main$wrap = F3(
	function (pageCon, msgCon, _n0) {
		var state = _n0.a;
		var msg = _n0.b;
		return _Utils_Tuple2(
			pageCon(state),
			A2(elm$core$Platform$Cmd$map, msgCon, msg));
	});
var author$project$Main$init = function (flags) {
	return A3(
		author$project$Main$wrap,
		author$project$Main$Loading,
		author$project$Main$LoadingMsg,
...
var elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {T: oldTime, ar: request, at: subs};
	});
...
var elm$browser$Browser$Events$onSelfMsg = F3(
	function (router, _n0, state) {
		...
		var messages = A2(elm$core$List$filterMap, toMessage, state.at);
		return A2(
			elm$core$Task$andThen,
			function (_n1) {
	...
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				F2(
					function (w, h) {
						return A2(author$project$LoadingScreen$WindowResize, w, h);
					}))
			]));
};
var author$project$Main$KanjiMsg = function (a) {
	return {$: 1, a: a};
};
var elm$core$Platform$Sub$map = _Platform_map;
var author$project$Main$subscriptions = function (screen) {
	if (!screen.$) {
		var model = screen.a;
		return A2(
			elm$core$Platform$Sub$map,
			author$project$Main$LoadingMsg,
			author$project$LoadingScreen$subscriptions(model));
	} else {
		var model = screen.a;
		return A2(
			elm$core$Platform$Sub$map,
...
var author$project$KanjiScreen$Model = F6(
	function (aspect, padding, tiles, gridSize, time, iterTime) {
		return {_: aspect, Q: gridSize, y: iterTime, A: padding, D: tiles, E: time};
	});
var author$project$KanjiScreen$kanjiOrder = F2(
	function (ka, kb) {
		return A2(
			elm$core$Basics$compare,
			A2(elm$core$Maybe$withDefault, 100, ka.aS),
			A2(elm$core$Maybe$withDefault, 100, kb.aS));
	});
...
var author$project$Layout$bestFit = F2(
	function (numItems, aspectRatio) {
		var fn = numItems;
		var h = elm$core$Basics$sqrt(fn / aspectRatio);
		var w = fn / h;
		return _Utils_Tuple2(
		...
		return A2(
			...
			function (x) {
				return A2(
					...
					A2(elm$core$List$range, s2, e2));
			},
			A2(elm$core$List$range, s1, e1));
	});
...
var author$project$Layout$makeGrid = function (_n0) {
	var w = _n0.a;
	var h = _n0.b;
	return elm$core$Set$fromList(
		A2(
			author$project$Utils$pairRange,
			_Utils_Tuple2(0, 0),
			_Utils_Tuple2(w - 1, h - 1)));
};
...
var author$project$Layout$freeCell = F3(
	function (grid, size, _n0) {
		var x = _n0.a;
		var y = _n0.b;
		if (size === 1) {
			return A2(
			...
			return A2(
				elm$core$List$all,
				function (pos) {
					return A2(elm$core$Set$member, pos, grid);
				},
				A2(
					author$project$Utils$pairRange,
					_Utils_Tuple2(x, y),
					_Utils_Tuple2((x + size) - 1, (y + size) - 1)));
		}
	});
...
var author$project$Layout$freeCells = F2(
	function (grid, size) {
		var list = elm$core$Set$toList(grid);
		if (size === 1) {
			return list;
		} else {
			return A2(
				elm$core$List$filter,
				A2(author$project$Layout$freeCell, grid, size),
				list);
		}
	});
...
var author$project$Layout$insertInGrid = F3(
	function (grid, size, _n0) {
		var x = _n0.a;
		var y = _n0.b;
		if (size === 1) {
...
var author$project$Layout$randomFill = F3(
	function (emptyGrid, allItems, initialSeed) {
		var rec = F4(
			function (grid, items, seed, result) {
				...
				while (true) {
					if (!items.b) {
						...
						var size = _n1.b;
						var rest = items.b;
						var spots = A2(author$project$Layout$freeCells, grid, size);
						var _n2 = A2(
							elm$random$Random$step,
							elm_community$random_extra$Random$List$choose(spots),
							seed);
						var _n3 = _n2.a;
						var maybeSpot = _n3.a;
						var newSeed = _n2.b;
						if (maybeSpot.$ === 1) {
							...
							var spot = maybeSpot.a;
							var $temp$grid = A3(author$project$Layout$insertInGrid, grid, size, spot),
								$temp$items = rest,
								$temp$seed = newSeed,
								$temp$result = A2(
								elm$core$List$cons,
								_Utils_Tuple3(item, size, spot),
								result);
							grid = $temp$grid;
							items = $temp$items;
							seed = $temp$seed;
		...
		return A4(rec, emptyGrid, allItems, initialSeed, _List_Nil);
	});
...
var author$project$KanjiScreen$init = F3(
	function (aspect, padding, kanjis) {
		var _n0 = function (l) {
			return A3(
				author$project$Layout$computeLayout,
				l,
				aspect,
		...
		var tiles = _n0.a;
		var gridSize = _n0.b;
		return A6(author$project$KanjiScreen$Model, aspect, padding, tiles, gridSize, 0.0, 0.0);
	});
var author$project$KanjiScreen$shuffle = F2(
	function (model, time) {
		...
		var _n0 = function (l) {
			return A3(author$project$Layout$computeLayout, l, model._, seed);
		}(
			A2(
				elm$core$List$map,
				function (_n3) {
		...
		return _Utils_update(
			model,
			{Q: gridSize, y: 0, D: shuffled, E: time});
	});
		...
		if (!msg.$) {
			...
			return _Utils_Tuple2(
				A3(
					...
					(width - (2 * model.A)) / (height - (2 * model.A)),
					model.A,
					A2(
						elm$core$List$map,
						function (_n1) {
			...
			var t = msg.a;
			var newTime = model.E + (t / 1000);
			var iterTime = model.y + (t / 1000);
			var updated = (_Utils_cmp(iterTime, author$project$KanjiScreen$shufflePeriod) > 0) ? A2(author$project$KanjiScreen$shuffle, model, newTime) : _Utils_update(
				model,
				{y: iterTime, E: newTime});
	...
	function (msg, state) {
		if (!msg.$) {
			...
			return _Utils_update(
				state,
				{
					_: elm$core$Maybe$Just((width - (2 * state.A)) / (height - (2 * state.A)))
				});
		}
	});
			...
			if (!_n0.a.$) {
				if (!_n0.b.$) {
					...
					var nextState = function () {
						var _n1 = _Utils_Tuple2(updatedState._, updatedState.M);
						if ((!_n1.a.$) && (!_n1.b.$)) {
							var aspect = _n1.a.a;
							var kanjis = _n1.b.a;
							return author$project$Main$Kanji(
								A3(author$project$KanjiScreen$init, aspect, model.A, kanjis));
						} else {
...
var author$project$Anim$sine = function (x) {
	return elm$core$Basics$sin(
		elm$core$Basics$turns(x));
};
var elm$core$Basics$abs = function (n) {
	return (n < 0) ? (-n) : n;
};
var elm$core$Basics$pow = _Basics_pow;
var author$project$Anim$vibrate = function (t) {
	return (author$project$Anim$sine(t * 10.0) * A2(
		elm$core$Basics$pow,
		1 - elm$core$Basics$abs(
			author$project$Anim$sine(t / 8.0)),
		3)) * 5.0;
};
...
var author$project$Anim$cose = function (x) {
	return elm$core$Basics$cos(
		elm$core$Basics$turns(x));
};
var author$project$Anim$plasma = F3(
	function (x, y, t) {
...
var author$project$Anim$toCss = function (_n0) {
	var r = _n0.a;
	var g = _n0.b;
	var b = _n0.c;
	return 'rgb(' + (elm$core$String$fromInt(
		elm$core$Basics$floor(r * 255.0)) + (',' + (elm$core$String$fromInt(
		elm$core$Basics$floor(g * 255.0)) + (',' + (elm$core$String$fromInt(
		elm$core$Basics$floor(b * 255.0)) + ')')))));
};
var author$project$KanjiScreen$kanjiColor = F3(
	function (k, time, _n0) {
		var x = _n0.a;
		var y = _n0.b;
		var _n1 = k.aS;
		if (_n1.$ === 1) {
			return author$project$Anim$toCss(
				author$project$Anim$grayscale(
					function (u) {
						return 0.15 + (u * 5.0e-2);
					}(
						A3(author$project$Anim$plasma, x, y, time))));
		} else {
			var level = _n1.a;
			return author$project$Anim$toCss(
				author$project$Anim$grayscale(0.93));
		}
	});
...
var author$project$KanjiScreen$viewKanji = F5(
	function (time, iterTime, numTiles, index, _n0) {
		var data = _n0.a;
		var size = _n0.b;
		var _n1 = _n0.c;
		var x = _n1.a;
		...
		var leech = A2(
			...
			A2(
				elm$core$Maybe$map,
				elm$core$Basics$ge(0.75),
				data.aE));
		var leechRot = leech ? author$project$Anim$vibrate(time + (index / 100)) : 0.0;
		var fade = (index * author$project$KanjiScreen$fadeInTime) / numTiles;
		var show = (_Utils_cmp(iterTime, 1.0 + fade) > 0) && (_Utils_cmp(iterTime, ((author$project$KanjiScreen$shufflePeriod - author$project$KanjiScreen$fadeInTime) - 1.0) + fade) < 0);
		var disp = show ? elm$svg$Svg$Attributes$transform(
			'translate(' + (elm$core$String$fromInt(x * author$project$KanjiScreen$referenceScale) + (' ' + (elm$core$String$fromInt(y * author$project$KanjiScreen$referenceScale) + (')' + (' scale(' + (elm$core$String$fromInt(size) + (')' + (' rotate(' + (elm$core$String$fromFloat(leechRot) + (',' + (elm$core$String$fromFloat(author$project$KanjiScreen$referenceScale / 2.0) + (',' + (elm$core$String$fromFloat(author$project$KanjiScreen$referenceScale / 2.0) + ')')))))))))))))) : elm$svg$Svg$Attributes$display('none');
		return A2(
			elm$svg$Svg$text_,
			_List_fromArray(
				[
					...
					A3(
						author$project$KanjiScreen$kanjiColor,
						data,
						time,
						_Utils_Tuple2(x, y))),
					disp,
...
var author$project$KanjiScreen$viewKanjis = F5(
	function (tiles, _n0, time, iterTime, padding) {
		var w = _n0.a;
		var h = _n0.b;
		...
		return A2(
			...
			_List_fromArray(
				[
					elm$svg$Svg$Attributes$viewBox('0 0 ' + (tw + (' ' + th))),
					elm$svg$Svg$Attributes$style(
					'margin:auto; width: calc(100% - ' + (elm$core$String$fromInt(2 * padding) + ('px); height: calc(100% - ' + (elm$core$String$fromInt(2 * padding) + 'px);'))))
				]),
...
var author$project$KanjiScreen$view = function (state) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				A5(author$project$KanjiScreen$viewKanjis, state.D, state.Q, state.E, state.y, state.A)
			]));
};
var elm$html$Html$text = elm$virtual_dom$VirtualDom$text;
var author$project$LoadingScreen$view = function (state) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						A2(elm$core$Maybe$withDefault, 'ロード中', state.K))
					]))
			]));
};
...
var author$project$Main$view = function (screen) {
	if (!screen.$) {
		...
		return A2(
			elm$html$Html$map,
			author$project$Main$LoadingMsg,
			author$project$LoadingScreen$view(model));
	} else {
		var model = screen.a;
		return A2(
			elm$html$Html$map,
			author$project$Main$KanjiMsg,
			author$project$KanjiScreen$view(model));
	}
};
var elm$browser$Browser$element = _Browser_element;
var author$project$Main$main = elm$browser$Browser$element(
	{aL: author$project$Main$init, aU: author$project$Main$subscriptions, aW: author$project$Main$update, aY: author$project$Main$view});
